...
public class JwtConfig {
    ...
    public Key loadJwtPrivateKey()
        ...
        keyStore.load(getClass().getClassLoader().getResourceAsStream("trading-waza.jks"), keystorePwd.toCharArray());
    ...
    public PublicKey loadJwtPublicKey() throws Exception {
        ...
        Certificate cert = cf.generateCertificate(getClass().getClassLoader().getResourceAsStream("trading-waza.cer"));
